...
with rep.new_layer():
    ...
    # Generate frames
    with rep.trigger.on_frame(num_frames=800, rt_subframes=10): # num_frames to be changed
        rep.randomizer.get_gears()

    # Initialize and attach writer
    writer = rep.WriterRegistry.get("BasicWriter")
    writer.initialize(
        output_dir="~/Documents/GearProject/gearproject/datasets/p04_flying_gears",
        rgb=True,
