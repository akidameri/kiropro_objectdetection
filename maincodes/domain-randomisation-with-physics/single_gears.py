...
with rep.new_layer():
    ...
    def get_gears():
        instances = rep.randomizer.instantiate(rep.utils.get_usd_files(GEAR, recursive=True), size=rep.distribution.choice([2,3,4]), mode='scene_instance')
        with instances:
    ...
    writer.initialize(
        output_dir="~/Documents/GearProject/gearproject/datasets/p01_single",
        rgb=True,
