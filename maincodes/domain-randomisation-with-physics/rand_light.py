...
with rep.new_layer():
    ...
    # Randomize intensity and temperature of the dome light
    def rand_dome_light():
        d_lights = rep.create.light(
            light_type="Dome",
            rotation=(270,0,0),
            texture=('omniverse://localhost/NVIDIA/Assets/Skies/Indoor/ZetoCGcom_ExhibitionHall_Interior1.hdr'),
    ...
    rep.randomizer.register(rand_dome_light)
    ...
    # Generate frames
    with rep.trigger.on_time(interval=2.5, num=308, rt_subframes=10): # num_frames to be changed
        rep.randomizer.get_gears()
        rep.randomizer.env_props()
        rep.randomizer.rand_dome_light()
        with camera:
    ...
    writer.initialize(
        output_dir="~/Documents/GearProject/gearproject/datasets/p08.2_light",
        rgb=True,
