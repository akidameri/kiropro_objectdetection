...
with rep.new_layer():
    ...
    HOR_GEARS = 'omniverse://localhost/Projects/GearGenerator/Gears/Horizontal/Spur_hor'
    VER_GEARS = 'omniverse://localhost/Projects/GearGenerator/Gears/Vertical/Spur_ver'
    ...
    writer.initialize(
        output_dir="~/Documents/GearProject/gearproject/datasets/02_spur",
        rgb=True,
