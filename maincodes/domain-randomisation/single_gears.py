...
with rep.new_layer():
    ...
    HOR_GEARS = 'omniverse://localhost/Projects/GearGenerator/Gears/Horizontal/Spur_hor/gear_01.usd'
    VER_GEARS = 'omniverse://localhost/Projects/GearGenerator/Gears/Vertical/Spur_ver/gear_01.usd'
