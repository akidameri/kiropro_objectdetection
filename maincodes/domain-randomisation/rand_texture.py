...
with rep.new_layer():
    ...
    # Texture choices
    tex = ['omniverse://localhost/NVIDIA/Materials/vMaterials_2/Carpet/textures/carpet_rough_woven_diff.jpg',
           'omniverse://localhost/NVIDIA/Materials/vMaterials_2/Composite/textures/carbon_fiber_fibers_norm.jpg',
           'omniverse://localhost/NVIDIA/Materials/vMaterials_2/Concrete/textures/conrete_formed_norm.jpg',
           'omniverse://localhost/NVIDIA/Materials/vMaterials_2/Metal/textures/hammered_norm.jpg',
           'omniverse://localhost/NVIDIA/Materials/vMaterials_2/Paper/textures/paper_plain_norm.jpg',
           'omniverse://localhost/NVIDIA/Materials/vMaterials_2/Metal/textures/brushed_metal_linear_norm.jpg',
           'omniverse://localhost/NVIDIA/Materials/vMaterials_2/Paint/textures/Chalk_Paint_Pebbles_norm.jpg',
           'omniverse://localhost/NVIDIA/Materials/vMaterials_2/Plastic/textures/pcb_prepreg_norm.jpg',
           'omniverse://localhost/NVIDIA/Materials/vMaterials_2/Stone/textures/natural_stone_black_norm.jpg',
           'omniverse://localhost/NVIDIA/Materials/vMaterials_2/Fabric/textures/polyester_twill_norm.jpg']
    ...
    def get_hor_gears():
        ...
        with instances:
            ...
            rep.randomizer.texture(textures=tex)
    ...
    writer.initialize(
        output_dir="~/Documents/GearProject/gearproject/datasets/04_texture",
        rgb=True,
